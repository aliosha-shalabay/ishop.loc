...
$lang = array(
    ...
    "The image is too big and/or cannot be resized." => "зображення слишком большое и/или не может быть уменьшено.",
    ...
    "Please enter new folder name." => "Укажите Імя новой папки.",
    "Unallowable characters in folder name." => "Недопустимые символы в имени папки.",
    "Folder name shouldn't begins with '.'" => "Імя папки не может начинаться с '.'",
    "Please enter new file name." => "Укажите новое Імя файла",
    "Unallowable characters in file name." => "Недопустимые символны в имени файла.",
    "File name shouldn't begins with '.'" => "Імя файла не может начинаться с '.'",
    "Are you sure you want to delete this file?" => "Вы уверены, что хотите Видалити этот файл?",
    "Are you sure you want to delete this folder and all its content?" => "Вы уверены, что хотите Видалити эту папку и всё её содержимое?",
    ...
    "Cannot delete '{file}'." => "Невозможно Видалити файл '{file}'.",
    "Cannot delete the folder." => "Невозможно Видалити папку.",
    ...
    "The files in the Clipboard are not removable." => "Невозможно Видалити файлы в буфере обмена.",
    "{count} files in the Clipboard are not removable. Do you want to delete the rest?" => "Невозможно Видалити {count} файл(ов) в буфере обмена. Вы хотите Видалити оставшиеся?",
    "The selected files are not removable." => "Невозможно Видалити выбранные файлы.",
    "{count} selected files are not removable. Do you want to delete the rest?" => "Невозможно Видалити выбранный(е) {count} файл(ы). Вы хотите Видалити оставшиеся?",
    "Are you sure you want to delete all selected files?" => "Вы уверены, что хотите Видалити все выбранные файлы?",
    "Failed to delete {count} files/folders." => "Невозможно Видалити {count} файлов/папок.",
    ...
    "Delete files" => "Видалити файлы",
    "Clear the Clipboard" => "Очистить буфер обмена",
    "Are you sure you want to delete all files in the Clipboard?" => "Вы уверены, что хотите Видалити все файлы в буфере обмена?",
    "Copy {count} files" => "Скопировать {count} файл(ов)",
    "Move {count} files" => "Переместить {count} файл(ов)",
    "Add to Clipboard" => "Додати в буфер обмена",
    "Inexistant or inaccessible folder." => "Несуществующая или недоступная папка.",
    "New folder name:" => "Новое Імя папки:",
    "New file name:" => "Новое Імя файла:",
    "Upload" => "Загрузить",
    "Refresh" => "Обновить",
    "Settings" => "Установки",
    "Maximize" => "Развернуть",
    ...
    "Cancel" => "Отмена",
    "Select" => "Вибрать",
    "Select Thumbnail" => "Вибрать миниатюру",
    "Select Thumbnails" => "Вибрать миниатюры",
    "View" => "Просмотр",
    "Download" => "Скачать",
