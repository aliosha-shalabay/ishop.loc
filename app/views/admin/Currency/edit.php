                ...
                <form method="post" action="<?= ADMIN ?>/currency/edit" role="form" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Навзва валюти" required value="<?= h($currency->title) ?>">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value" placeholder="Значення" pattern="^[0-9.]{1,}$" required data-error="Допускаются цифры и десятичная точка" value="<?= $currency->value ?>">
